...
class DoctorBankDetails(models.Model):
    ...
    bank_qr_code = models.TextField(null=True, blank=True)  # Store image as base64 string
    bank_qr_code_content_type = models.CharField(max_length=50, null=True, blank=True)

    class Meta:
        db_table = 'doctor_bank_details'

    def __str__(self):
        return f"Bank details for {self.doctor.contact_number}"
